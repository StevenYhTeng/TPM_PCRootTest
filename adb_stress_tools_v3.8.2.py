...
class ADBStressGUI:
    def __init__(self, root):
        self.root = root
        self.root.title("Android ADB Stress Test Console (TPM/APM Edition) v3.8.4")
    ...
    def get_local_subnet_prefix(self):
        """Dynamically detect the active local subnet of the PC"""
        try:
            s = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
            # Connect to a public IP to force OS to resolve local routing interface
            ...
            # Fallback subnet if no active network is found
            return "192.168.1."
    ...
    def setup_ui(self):
        ...
        # Automatically detect and insert local subnet
        ...
        # 🌟 Modified: Changed "Scan Wi-Fi" to "Scan"
        ...
        self.chk_do_shutdown = tk.Checkbutton(self.reboot_frame, text="🛑 Include Shutdown Phase\n(Warning: Device will stay off if no hardware auto-wake exists)", variable=self.do_shutdown_var, fg="#F44336", justify=tk.LEFT)
        ...
        # --- Right Panel: TPM APM Dashboard + Logs ---
        ...
        self.ui_log(f"System ready. Automatically detecting local subnet and initializing scan...")
    ...
    def init_usb_tcpip(self):
        ...
        try:
            ...
            # 🌟 Modified: Updated message to reflect 'Scan' button name
